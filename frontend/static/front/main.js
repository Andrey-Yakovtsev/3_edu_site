...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\nvar courses_url = 'http://127.0.0.1:8000/api/courses/';\n\nfunction getCoursesInfo(cb) {\n  axios__WEBPACK_IMPORTED_MODULE_0___default().get(courses_url).then(function (response) {\n    return cb(response.data);\n  });\n}\n\nvar modules_url = 'http://127.0.0.1:8000/api/modules/';\n\nfunction getModulesInfo(cb) {\n  fetch(modules_url).then(function (response) {\n    return response.json();\n  }).then(function (data) {\n    return cb(data);\n  });\n}\n\ngetCoursesInfo(console.log);\ngetModulesInfo(console.log.bind(console, 'getModulesInfo'));\n\n//# sourceURL=webpack://frontend/./src/index.js?");
